...
* iMac has the largest frequency by a significant margin.
...
Creating the association rules and examining itemsets with positive association rules, an interesting picture does begin to emerge:
