...
If Blackwell were to acquire Electronidex it would represent a move into the B2B/Distribution side of the electronic retail business. This would be an advantageous move if doing so allowed Blackwell to purchase stock more easily and inexpensively or if Blackwell wanted to purchase stock which is currently difficult to acquire.

The stock sold by Electronidex has some overlap to that sold by Blackwell but purchasing it would mean taking over stocks that we do not currently sell. Our analysis has shown that the non-shared stock offered by Electronidex does not complement the products we currently sell.
